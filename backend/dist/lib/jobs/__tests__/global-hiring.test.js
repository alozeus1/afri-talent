...
import { evaluateJobQuality, evaluateCandidatePreferenceMatch, buildJobDiscoverySummary, evaluateFreshness, } from "../discovery.js";
import { AFRICA_FRIENDLY_KEYWORDS, AFRICAN_COUNTRIES, } from "../aggregator/types.js";
...
function baseJob(overrides = {}) {
    return {
        ...
        description: "We are looking for a Backend Engineer with 4+ years of experience in Node.js, " +
...
describe("global-hiring / Africa-friendly keyword detection", () => {
    ...
    it("a description containing Africa-friendly keywords matches the constant", () => {
        const jobDescription = "We offer visa sponsorship and relocation assistance for candidates from sub-saharan Africa. " +
...
//# sourceMappingURL=global-hiring.test.js.map