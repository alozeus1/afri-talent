...
export async function explainCareerGap(input) {
...
Create a professional, honest, and positive framing of this career gap. Return ONLY valid JSON:
{
  ...
  "talkingPoints": ["<3-4 specific talking points for interviews about this gap>"]
    ...
    if (!jsonMatch)
        throw new Error("No JSON in gap explainer response");
    const parsed = JSON.parse(jsonMatch[0]);
    return { ...parsed, source: "ai" };
}
function buildGapMock(input) {
    return {
...
//# sourceMappingURL=career-gap-explainer.js.map