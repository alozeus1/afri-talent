...
export async function generateNegotiationGuidance(input) {
...
Provide practical, market-aware salary negotiation guidance. Return ONLY valid JSON:
{
  ...
  "negotiationScript": "<A 3-4 sentence script for asking for more compensation>"
    ...
    if (!jsonMatch)
        throw new Error("No JSON in salary negotiator response");
    const parsed = JSON.parse(jsonMatch[0]);
    return { ...parsed, source: "ai" };
}
function buildNegotiationMock(input) {
...
//# sourceMappingURL=salary-negotiator.js.map