...
describe("quality-rubric / resume quantification", () => {
    ...
    it("does not flag a resume with clear numbers", () => {
        const prose = "Led a team of 6 engineers. Reduced checkout latency by 42%. Grew MRR from $2k to $48k over 12 months. Increased conversion from 1.8% to 3.4%. Shipped 15 production services." +
...
describe("quality-rubric / filler density", () => {
    it("flags high filler density", () => {
        const text = "I am really very basically just actually very literally simply the best candidate you will kind of find.".repeat(3);
...
describe("quality-rubric / keyword coverage", () => {
    ...
    it("passes when all expected keywords are present", () => {
        const r = gradeAiOutput({
            text: "Senior React engineer with 6 years of TypeScript and AWS experience. Led migration reducing costs by 35%. Shipped 12 production React apps over 3 years serving 200k users.",
            kind: "resume",
            expectedKeywords: ["React", "TypeScript", "AWS"],
        });
...
//# sourceMappingURL=quality-rubric.test.js.map