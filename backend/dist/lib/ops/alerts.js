 ...
 */
export async function getActiveLerts(severity) {
    try {
 ...
 */
export async function checkAndCreateHealthAlert(category, isHealthy, details, metrics) {
    if (isHealthy) {
 ...
 */
export async function checkAndCreateThresholdAlert(category, name, current, threshold, unit) {
