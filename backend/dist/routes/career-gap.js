...
router.post("/explain", authenticate, authorize(Role.CANDIDATE), makeMonthlySkillQuota(AiRunType.CAREER_GAP_EXPLAIN, 3), async (req, res) => {
...
//# sourceMappingURL=career-gap.js.map