...
function getTemplateSteps(visaType) {
    const template = VISA_TEMPLATES.find((t) => t.visaType.toLowerCase() === visaType.toLowerCase());
...
router.post("/processes/:id/steps", authenticate, async (req, res) => {
    const { id } = req.params;
...
router.put("/processes/:id/steps/:stepId", authenticate, async (req, res) => {
