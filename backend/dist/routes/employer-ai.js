...
function generateJobDescriptionDraft(input) {
...
router.post("/job-description-drafts", aiToolLimiter, async (req, res) => {
    try {
...
router.post("/candidate-ranking-drafts", aiToolLimiter, async (req, res) => {
    try {
...
//# sourceMappingURL=employer-ai.js.map