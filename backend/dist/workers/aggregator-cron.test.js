...
function buildSourceDiagnostics(source, status, jobsFetched, errorCount = 0) {
    return {
        source,
        status,
        jobsFetched,
...
function buildDiagnostics(sourceDiagnostics, hadErrors) {
...
//# sourceMappingURL=aggregator-cron.test.js.map