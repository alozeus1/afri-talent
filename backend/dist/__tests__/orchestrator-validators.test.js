...
import { ResumeSchemaValidator, JobSchemaValidator, MatchSchemaValidator, TailoredResumeSchemaValidator, CoverLetterPackSchemaValidator, GuardReportSchemaValidator, } from "../lib/ai/orchestrator/validators.js";
...
describe("JobSchemaValidator", () => {
    ...
    it("accepts all valid visa_sponsorship values", () => {
        for (const val of ["YES", "NO", "UNKNOWN"]) {
...
describe("MatchSchemaValidator", () => {
    ...
    it("accepts all valid recommendation values", () => {
        for (const rec of ["apply", "stretch", "skip"]) {
...
describe("CoverLetterPackSchemaValidator", () => {
    ...
    it("accepts all valid tone values", () => {
        for (const tone of ["professional", "warm", "direct"]) {
...
//# sourceMappingURL=orchestrator-validators.test.js.map