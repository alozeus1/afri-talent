...
describe("semantic retrieval foundation", () => {
    ...
    it("scores related text higher than unrelated text", () => {
        const relevant = semanticTextScore("backend engineer node prisma postgres", "Senior backend engineer working with Node.js, Prisma, and PostgreSQL in production systems.");
        const unrelated = semanticTextScore("backend engineer node prisma postgres", "Creative social media manager building brand campaigns for fashion retail.");
...
//# sourceMappingURL=semantic-foundation.test.js.map