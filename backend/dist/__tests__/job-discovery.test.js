...
import { buildJobIntelligenceUpdate, buildSourceFingerprint, collapseDuplicateRankedJobs, evaluateFreshness, evaluateJobQuality, scoreJobForSearch, } from "../lib/jobs/discovery.js";
const baseJob = {
    id: "job_1",
    title: "Senior Backend Engineer",
    description: "Join our team to build reliable APIs, distributed systems, hiring workflows, and data products for cross-border recruitment. You will work with Node.js, TypeScript, PostgreSQL, queues, and cloud infrastructure.",
...
describe("job discovery intelligence", () => {
    ...
    it("merges source lineage into persisted job intelligence", () => {
        ...
        const lineage = intelligence.sourceLineage;
