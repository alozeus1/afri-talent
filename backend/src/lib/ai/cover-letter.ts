...
export async function generateQuickCoverLetter(
...
async function generateWithAI(input: CoverLetterInput): Promise<string> {
...
function generateTemplate(input: CoverLetterInput): string {
