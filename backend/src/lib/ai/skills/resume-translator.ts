...
export const LANGUAGE_NAMES: Record<SupportedTranslationLanguage, string> = {
  fr: "French",
  pt: "Portuguese",
  ar: "Arabic",
  sw: "Swahili",
...
export async function translateResume(input: ResumeTranslateInput): Promise<ResumeTranslateResult> {
...
async function generateWithClaude(input: ResumeTranslateInput): Promise<ResumeTranslateResult> {
