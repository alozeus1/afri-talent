...
import {
  ...
  Prisma,
  Role,
  UniversityPartnerStatus,
  UniversityRecordStatus,
...
router.get("/admin/partners/:partnerId/records", authenticate, authorize(Role.ADMIN), async (req: Request, res: Response) => {
  try {
...
router.post("/admin/partners/:partnerId/markers", authenticate, authorize(Role.ADMIN), async (req: Request, res: Response) => {
  try {
...
router.post("/admin/partners/:partnerId/verified-skills", authenticate, authorize(Role.ADMIN), async (req: Request, res: Response) => {
  try {
