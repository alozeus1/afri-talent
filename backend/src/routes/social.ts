...
router.get("/connections", async (req: Request, res: Response) => {
  try {
    const status = req.query.status as SocialConnectionStatus | undefined;
    const where = {
      ...(status ? { status } : {}),
...
router.post("/connections/request", connectionLimiter, async (req: Request, res: Response) => {
  try {
...
router.post("/connections/:id/respond", connectionLimiter, async (req: Request, res: Response) => {
  try {
